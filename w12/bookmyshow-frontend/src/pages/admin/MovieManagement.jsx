...
export default function MovieManagement() {
  ...
  return (
    <section>
      ...
      <MovieForm initialData={editingMovie} onSubmit={handleSubmit} buttonText={editingMovie ? "Update Movie" : "Create Movie"} />
      {loading ? <p>Loading movies...</p> : (
        <div style={styles.tableContainer}>
          <table style={styles.table}>
            <thead>
              <tr>
                <th>Title</th><th>Genre</th><th>Rating</th><th>Duration</th><th>Release Date</th><th>Actions</th>
              </tr>
            </thead>
            <tbody>
              {movies.map((movie) => (

...
import { getShows, createShow, updateShow, deleteShow } from "../../api/show.api";
...
export default function ShowManagement() {
  ...
  return (
    <section>
      ...
      <ShowForm movies={movies} onSubmit={handleSubmit} initialData={editingShow} buttonText={editingShow ? "Update Show" : "Create Show"} />
      <table style={{ width: "100%" }}>
        <thead>
          <tr>
            <th>Movie</th><th>Date</th><th>Time</th><th>Total Seats</th><th>Available Seats</th><th>Actions</th>
          </tr>
        </thead>
        <tbody>
          {shows.map((show) => (
